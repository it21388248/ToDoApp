...
function App() {
 ...
 const addItem = async (e) =>{
  ...
  try{
      const res = await axios.post('http://localhost:8000/api/item',{item:itemText})
 ...
 //before updationg item we need to show input field where we will create our update
